...
struct CategoryItemView: View  {
    ...
    // Inject the categoryDetailViewModel as an environment object
    @StateObject private var categoryDetailViewModel = CategoryDetailViewModel(itemsService: ItemsService(networkService: NetworkService()))
    
    var body: some View {
        NavigationLink(destination: CategoryDetailView(category: category)
            .environmentObject(categoryDetailViewModel)) {
